...
export default function WalletPage() {
  ...
  const handleTopup = (e: React.FormEvent) => {
    ...
    depositWallet(amt);
    setTopupAmt("");
    toast.success(`Top Up sebesar Rp ${amt.toLocaleString("id-ID")} sukses dilakukan!`);
  };
  ...
  const handleWithdraw = (e: React.FormEvent) => {
    ...
    if (success) {
      setWithdrawAmt("");
      toast.success(`Penarikan dana sebesar Rp ${amt.toLocaleString("id-ID")} sukses diajukan ke BUMDes!`);
    } else {
